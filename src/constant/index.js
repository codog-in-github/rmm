...
export const GOODS_SPEC_TRASH =  '废';
export const GOODS_SUB_SPEC_JIAOZHI = '矫';

export const GOODS_SPEC_SCENES_ORDER = 1; // 订单

export const GOODS_SPEC_SCENES_STOREHOUSE = 2; // 仓库

export const GOODS_SPEC_SCENES_WORKSHOP = 3; //  车间

...
interface window {
    LODOP: null | {
        ...
        PRINT_INITA: {
            (strPrintTask?: string): true
            (top?: number, left?: number , width?: number, height?: number, strPrintTask?: string): true
        }
        ...
        NEWPAGE: () => void,
        SET_PRINT_PAGESIZE: (intOrient: 0|1|2|3, PageWidth?: number|string, PageHeight?: number|string, strPageName?: string) =>  void,
